...
do
    ## reading each line
    log_filename=$1-morl_off_policy_const_pref2-g$2-n$3-$line
    echo "$log_filename"
    python ./morl_off_policy_const_pref2.py --env="$1" --gamma="$2" --noise="$3" --seed="$line"  >> logfiles/"$log_filename" 2>&1 &
